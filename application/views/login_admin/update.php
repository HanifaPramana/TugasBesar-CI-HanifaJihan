          ...
          <div class="row">
            <div class="col">
              ...
              <div class="card-body">
               ...
               <?php echo form_open('login_admin/update/'.$login_admin['id']) ?>
               <div class="form-group">
                 <label for="">Username</label>
                 <input type="text" name="no_kamar" class="form-control" value="<?php echo $login_admin['username'] ?>">
               </div>
               <div class="form-group">
                 <label for="">Password</label>
                 <input type="text" name="password" class="form-control" value="<?php echo $login_admin['password'] ?>">
               </div>
               <div class="form-group">
